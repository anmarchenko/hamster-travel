defmodule HamsterTravelWeb.UserAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, HamsterTravelWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      HamsterTravelWeb.Endpoint.subscribe(live_socket_id)
  ...
  describe "fetch_current_user/2" do
    ...
    test "sets the locale from the authenticated user", %{conn: conn} do
