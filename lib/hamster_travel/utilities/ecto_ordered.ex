defmodule HamsterTravel.EctoOrdered do
  @moduledoc """

  Copied and adapted from ecto-ordered library from zovafit:
  ...
  defp scope_query(query, %Options{scope_field: scope_fields, module: module}, cs)
       when is_list(scope_fields) do
