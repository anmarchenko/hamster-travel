defmodule HamsterTravel.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, HamsterTravel.Repo)
  ...
  """
  def valid_password?(%HamsterTravel.Accounts.User{hashed_password: hashed_password}, password)
