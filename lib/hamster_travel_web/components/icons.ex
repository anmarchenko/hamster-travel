defmodule HamsterTravelWeb.Icons do
  ...
  def budget(assigns) do
    ~H"""
    <svg width="18" stroke-width="1.5" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class={classes(assigns)}>
  ...
  def airplane(assigns) do
    ~H"""
    <svg width="24" height="24" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class={classes(assigns)}>
